...
var len__5972__auto___17806 = arguments.length;
var i__5973__auto___17807 = (0);
while(true){
if((i__5973__auto___17807 < len__5972__auto___17806)){
args__5979__auto__.push((arguments[i__5973__auto___17807]));

var G__17808 = (i__5973__auto___17807 + (1));
i__5973__auto___17807 = G__17808;
continue;
} else {
}
break;
...
return adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__5980__auto__);
});

adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__17804){
var vec__17805 = p__17804;
var opts = cljs.core.nth.call(null,vec__17805,(0),null);
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (conn,vec__17805,opts){
return (function (evt){
...
});})(conn,vec__17805,opts))
);

clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"message","message",-406056002),((function (conn,vec__17805,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (conn,vec__17805,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"error","error",-978969032),((function (conn,vec__17805,opts){
return (function (evt){
...
adzerk.boot_reload.client.connect.cljs$lang$applyTo = (function (seq17802){
var G__17803 = cljs.core.first.call(null,seq17802);
var seq17802__$1 = cljs.core.next.call(null,seq17802);
return adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic(G__17803,seq17802__$1);
});
